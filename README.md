...
- Provides short interaction tones in the original sound palette, an explicit speaker test, a persistent sound toggle, and strong best-effort haptics on browsers that expose device vibration.
