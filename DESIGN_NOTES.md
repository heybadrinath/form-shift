...
- The original short tonal palette acknowledges navigation, saved mutations, and errors without overstaying the interaction. The speaker menu provides a test plus an explicit mute control, and the mute preference persists in the current browser.
