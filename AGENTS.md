...
- Protect all private data and write operations with one owner PIN and a secure signed cookie. Do not add registration, profiles, social features, or a multi-user account model. Never commit the PIN, cookie secret, database URL, or production data.
